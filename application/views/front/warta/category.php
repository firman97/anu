                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 hidden-xs-down hidden-sm-down">
                        <ol class="breadcrumb">
                            ...
                            <?php foreach ($category->result() as $key => $categories) : ?>
                                <li class="breadcrumb-item"><a href="<?= base_url('warta/kategori/'.$categories->category_id); ?>"><?= $categories->category_name; ?></a></li>
                            <?php endforeach; ?>
                        </ol>
                    </div><!-- end col -->                    
                </div><!-- end row -->
