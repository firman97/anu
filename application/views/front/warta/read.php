                                            ...
                                            <div class="list-group">
                                                <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                                    <div class="w-100 justify-content-between text-right">
                                                        <img src="<?php echo base_url();?>assets/front/upload/blog_square_02.jpg" alt="" class="img-fluid float-right">
                            ...
                            <div class="custombox authorbox clearfix">
                                ...
                                <div class="row">
                                    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                        <img src="<?php echo base_url();?>assets/front/upload/author.jpg" alt="" class="img-fluid rounded-circle"> 
                                    </div><!-- end col -->
                                        ...
                                        <div class="comments-list">
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo base_url();?>assets/front/upload/author.jpg" alt="" class="rounded-circle">
                                                </a>
                                            ...
                                            <div class="media">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo base_url();?>assets/front/upload/author_01.jpg" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <div class="media last-child">
                                                <a class="media-left" href="#">
                                                    <img src="<?php echo base_url();?>assets/front/upload/author_02.jpg" alt="" class="rounded-circle">
                                                </a>
                                                <div class="media-body">
