                        ...
                        <div class="widget">
                            ...
                            <div class="blog-list-widget">
                                <div class="list-group">
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="<?php echo base_url();?>assets/front/upload/blog_square_04.jpg" alt="" class="img-fluid float-left">
                                    ...
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="<?php echo base_url();?>assets/front/upload/blog_square_07.jpg" alt="" class="img-fluid float-left">
                                    ...
                                    <a href="single.html" class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="<?php echo base_url();?>assets/front/upload/blog_square_06.jpg" alt="" class="img-fluid float-left">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="widget">
                            <div class="footer-text text-center">
                                <a href="index.html"><img src="<?php echo base_url();?>assets/front/images/flogo.png" alt="" class="img-fluid"></a>
